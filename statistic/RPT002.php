...
<body>
	<hr/>
	<h1>[RPT002] Complaints report by Customer </h1>
	<br/>
	
	<table id="table-a">
		<thead>
		<tr align="center">
			<th width="203" rowspan="2">Id Customer</th>
		</tr>
        <tr align="center">
			<th width="58">Complaint Total</th>
			<th width="59">Detail</th>
		</tr>
		</thead>
		<tbody>
			<?php 
			$ticket_list = $tickets->get_customer_complaint();
			foreach ($ticket_list as $ticket)
			{	
				echo '<tr><td>'.$ticket['idcustomer'].'</td>'.
					 '<td>'.$ticket['total'].'</td>';
			}
			?>
		</tbody>
